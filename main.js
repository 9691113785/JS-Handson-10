// const alok = document.getElementById('text')
// const alok = document.getElementsByTagName('h1')
// const alok = document.getElementsByClassName('box')
...
function onbuttonclick(){
    ...
    const alok = document.getElementsByTagName('h3')[0]
